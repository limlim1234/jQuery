            ...
            <div class="col-lg-9">
                ...
                <div class="row">
                    ...
                    <!-- <script>
                        ...
                        let a1 = $('<a />').attr('href', 'index.html'); //data.js에 있는 링크
                        let img1 = $('<img />').addClass('card-img-top').attr({'src': 'images/케냐.jpg', 'alt': '케냐이미지'});
                        let div3 = $('<div />').addClass('card-body');
                        let h_4 = $('<h4 />').addClass('card-title');
                        let a2 = $('<a />').attr('href', 'index.html').html('케냐산 원두입니다');
                        let h_5 = $('<h5 />').html('5,000');
                        let p1 = $('<p />').addClass('card-text').html('케냐산 원두');
                        let div4 = $('<div />').addClass('card-footer');
                        let small = $('<small />').addClass('text-muted').html('&#9733; &#9733; &#9733; &#9733; &#9734');
